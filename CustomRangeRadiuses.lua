...
local slider1 = Menu.AddOptionSlider({ "Utility", "Custom range radiuses", "Preset 1" }, "Radius range", 100, 1000, 100)
...
local slider2 = Menu.AddOptionSlider({ "Utility", "Custom range radiuses", "Preset 2" }, "Radius range", 100, 1500, 100)
...
local slider3 = Menu.AddOptionSlider({ "Utility", "Custom range radiuses", "Preset 3" }, "Radius range", 100, 2000, 100)
...
local slider4 = Menu.AddOptionSlider({ "Utility", "Custom range radiuses", "Preset 4" }, "Radius range", 100, 2500, 100)
...
local slider5 = Menu.AddOptionSlider({ "Utility", "Custom range radiuses", "Preset 5" }, "Radius range", 100, 3000, 100)
...
function CRR.OnMenuOptionChange(option, oldValue, newValue)
    ...
    elseif option == slider1 or option == color1 then
        if radiusparticle1 then
            ...
            Particle.SetControlPoint(radiusparticle1, 2, Vector(Menu.GetValue(slider1), 255, 255))
    ...
    elseif option == slider2 or option == color2 then    
        if radiusparticle2 then
            ...
            Particle.SetControlPoint(radiusparticle2, 2, Vector(Menu.GetValue(slider2), 255, 0))
    ...
    elseif option == slider3 or option == color3 then    
        if radiusparticle3 then
            ...
            Particle.SetControlPoint(radiusparticle3, 2, Vector(Menu.GetValue(slider3), 255, 0))    
    ...
    elseif option == slider4 or option == color4 then    
        if radiusparticle4 then
            ...
            Particle.SetControlPoint(radiusparticle4, 2, Vector(Menu.GetValue(slider4), 255, 0))
    ...
    elseif option == slider5 or option == color5 then    
        if radiusparticle5 then
            ...
            Particle.SetControlPoint(radiusparticle5, 2, Vector(Menu.GetValue(slider5), 255, 0))

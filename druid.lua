...
--Полное комбо
	...
	if Menu.IsKeyDown(Druid.optionFullCombo) and enemy and (not NPC.IsChannellingAbility(myHero)) and (not NPC.IsChannellingAbility(bear)) then
		...
		if  Menu.IsEnabled(Druid.optionOrchidMalevolenceB) and (not NPC.GetModifier(enemy, "modifier_orchid_malevolence_debuff")) and Druid.ItemTarget(orchidB, enemy, manaB) == true then
			return
		end
		...
		if Menu.IsEnabled(Druid.optionSheepStick) and (not NPC.GetModifier(enemy, "modifier_sheepstick_debuff")) and Druid.ItemTarget(sheepstick, enemy, mana) == true then
			return
		end
		...
		if  Menu.IsEnabled(Druid.optionOrchidMalevolence) and (not NPC.GetModifier(enemy, "modifier_orchid_malevolence_debuff")) and Druid.ItemTarget(orchid, enemy, mana) == true then
			return
		end
